...
var takesString []Attribute = []Attribute{
	_BACKGROUND,
	CHARSET,
	COLORSCHEME,
	COMMENT,
...
var takesColor []Attribute = []Attribute {
	BGCOLOR,
	COLOR,
	FILLCOLOR,
	FONTCOLOR,
...
func (a Attribute) TakesColor() bool {
	for _, c := range takesColor {
		if a == c {
			return true
		}
	}
